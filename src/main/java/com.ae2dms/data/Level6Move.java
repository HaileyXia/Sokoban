...
/**
 * Class Level6Move {@link Level6Move} is maintenance.
 *
 ...
 * @version 2.1
 */
public class Level6Move implements AllData{
     ...
     *
     * <p>Read all move count from level6.txt, write all move counts into level6.txt. Use method from CLass {@link GameData}.</p>
     *
    ...
    public void readMove() throws IOException {
        FileReader frMove = new FileReader("src/main/resources/data/level6.txt");
        arrayList = gameData.readFromFile(frMove);
        int size = arrayList.size();
        FileWriter fileWriter = new FileWriter("src/main/resources/data/level6.txt");
     ...
     *
     * <p>Read all usernames from name6.txt, write all usernames into name6.txt. Use method from CLass {@link GameData}.</p>
     *
     * @throws IOException Catch I/O exception
     * @since 2020/10/25
     */
    public void readName() throws IOException {
        FileReader frName = new FileReader("src/main/resources/data/name6.txt");
        nameList = gameData.readNameFromFile(frName);
        int nameSize = nameList.size();
        FileWriter fileWriter = new FileWriter("src/main/resources/data/name6.txt");
     ...
     *
     * <p>Read all time from time6.txt, write all time into time6.txt. Use method from CLass {@link GameData}.</p>
     *
     * @throws IOException Catch I/O exception
     * @since 2020/10/25
     */
    public void readTime() throws IOException{
        FileReader frTime = new FileReader("src/main/resources/data/time6.txt");
        timeList = gameData.readTimeFromFile(frTime);
        int timeSize = timeList.size();
        FileWriter fileWriter = new FileWriter("src/main/resources/data/time6.txt");
