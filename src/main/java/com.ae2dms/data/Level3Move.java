...
/**
 * Class Level3Move {@link Level3Move} is maintenance.
 *
 ...
 * @version 2.1
 */
public class Level3Move implements AllData{
     ...
     *
     * <p>Read all move count from level3.txt, write all move counts into level3.txt. Use method from CLass {@link GameData}</p>
     *
    ...
    public void readMove() throws IOException {
        FileReader frMove = new FileReader("src/main/resources/data/level3.txt");
        arrayList = gameData.readFromFile(frMove);
        int size = arrayList.size();
        FileWriter fileWriter = new FileWriter("src/main/resources/data/level3.txt");
     ...
     *
     * <p>Read all usernames from name3.txt, write all usernames into name3.txt. Use method from CLass {@link GameData}</p>
     *
     * @throws IOException Catch I/O exception
     * @since 2020/10/25
     */
    public void readName() throws IOException {
        FileReader frName = new FileReader("src/main/resources/data/name3.txt");
        nameList = gameData.readNameFromFile(frName);
        int nameSize = nameList.size();
        FileWriter fileWriter = new FileWriter("src/main/resources/data/name3.txt");
     ...
     *
     * <p>Read all time from time3.txt, write all time into time3.txt. Use method from CLass {@link GameData}</p>
     *
     * @throws IOException Catch I/O exception
     * @since 2020/10/25
     */
    public void readTime() throws IOException{
        FileReader frTime = new FileReader("src/main/resources/data/time3.txt");
        timeList = gameData.readTimeFromFile(frTime);
        int timeSize = timeList.size();
        FileWriter fileWriter = new FileWriter("src/main/resources/data/time3.txt");
